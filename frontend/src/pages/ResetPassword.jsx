...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
        ...
        const {data} = await axios.post(`${import.meta.env.VITE_ENDPOINT}/api/user/reset-password/${id}/${token}`, actualData, config);
        document.getElementById('reset-password-form').reset();
        setError({
          status: true,
          msg: "Password reset Sucessfully. Redirecting to login Page...",
          type: "success",
        });
        setLoading(false);
    ...
    <ThemeProvider theme={defaultTheme}>
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Box component="form" id='reset-password-form' noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
            <TextField
              margin='normal'
              required
              fullWidth
